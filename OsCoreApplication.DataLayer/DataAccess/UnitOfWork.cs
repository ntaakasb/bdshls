...
namespace OsCoreApplication.DataLayer.DataAccess
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private EFHoangLienSonDBEntities _dbContext;
        public EFHoangLienSonDBEntities DbContext => _dbContext ?? (_dbContext = new EFHoangLienSonDBEntities());

        public UnitOfWork()
        {
            _dbContext = new EFHoangLienSonDBEntities();
        }
